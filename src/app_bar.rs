...
pub fn create(display: &Display) -> Result<(), WinError> {
...
pub fn draw_datetime(hwnd: HWND) -> Result<(), WinError> {
	if !hwnd.is_null() {
...
use crate::workspace::{self, change, WORKSPACE_ID};
...
pub fn draw_workspace(idx: i32, id: i32, focused: bool) -> Result<(), WinError> {
